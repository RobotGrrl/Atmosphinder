/*
 * Robot Missions Atmosphinder Logger
 * ---------------------------
 *
 * Datalogging for Atmosphinder the robot
 *
...
#ifndef _ATMOSPHINDERLOGGER_H_
#define _ATMOSPHINDERLOGGER_H_
...
#define NUM_DATA_POINTS 38

struct LogLine { // 38 points
  time_t sample_time;
...
#define LOG_GPS_LATITUDE 22
#define LOG_GPS_LONGITUDE 23
#define LOG_GPS_ALTITUDE 24
#define LOG_GPS_SPEED 25
#define LOG_GPS_ANGLE 26
#define LOG_GPS_HDOP 27
#define LOG_GPS_VDOP 28
#define LOG_GPS_PDOP 29

#define LOG_BATTERY_SENSOR 30
#define LOG_WIND_SENSOR 31
#define LOG_COMM_XBEE_LATENCY 32
#define LOG_COMM_ARDUINO_LATENCY 33
#define LOG_PRESSURE 34
#define LOG_HUMIDITY 35
#define LOG_TEMPERATURE 36
#define LOG_AQ_DATA 37

// --

class AtmosphinderLogger {
